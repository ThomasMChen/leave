...
public class TriggerActivity extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.OnConnectionFailedListener, GoogleApiClient.ConnectionCallbacks, LocationListener{
    ...
    private double[] locations = {40.42752, -86.92035};
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng sydney = new LatLng(40,-86);
    ...
    public void checkLocationDistance(Location curr) {
        ...
        float dist = curr.distanceTo(setLocation);
        Toast.makeText(this, Float.toString(dist), Toast.LENGTH_SHORT).show();
